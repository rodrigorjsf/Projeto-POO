...
public class Aluno extends Pessoa {
    ...
    private Aluno(int id, double altura, double peso, String TipoDoTreino, String objetivos, String nome, String telefone, String email, String endereco, String cpf, int idade) {
